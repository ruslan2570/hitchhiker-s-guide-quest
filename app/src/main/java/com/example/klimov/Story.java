...
public class Story {
    ...
    public void hitTheRoad(){
        gs.text.setText("С помощью телепортирующего кольца Вы со своим другом оказываетесь на инопланетном корабле. Вы осознаете всю потребность в арахисе и полотенце. Поняв, что всё, что Вам дорого было уничтожено, Вам только и остается укрыться полотенцем и есть арахис. В иллюминаторе видна мимопролетающая вывеска \"Вкусно и точка\".\n\nКонец первой части. Продолжение не следует.");
